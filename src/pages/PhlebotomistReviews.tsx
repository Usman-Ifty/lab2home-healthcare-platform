    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [reviewsRes, statsRes] = await Promise.all([
                feedbackService.getFeedbackForTarget("phlebotomist", user.id, { page, limit: 10 }),
                feedbackService.getRatingStats("phlebotomist", user.id)
            ]);
            ...
            console.error("Error fetching phlebotomist reviews:", error);
        ...
        <DashboardLayout role="phlebotomist">
            <div className="relative z-10 space-y-8 max-w-6xl mx-auto pb-12">
                ...
                <motion.div
                    ...
                    className="bg-gradient-to-br from-green-50 to-emerald-50/30 rounded-3xl p-8 shadow-sm border border-green-100 relative overflow-hidden"
                >
                    ...
                    <div className="flex items-center gap-6 relative z-10">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green-100 to-green-200 shadow-inner shrink-0 text-green-700">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-2 max-w-2xl leading-relaxed">
                                See what patients are saying about your home sample collection service.
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                {loading && !reviews.length ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            <Card className="rounded-3xl shadow-sm border-green-100/50 bg-white sticky top-6">
                            ...
                            {reviews.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-16 bg-white rounded-3xl border border-dashed border-gray-200 text-center px-4">
                                    ...
                                    <p className="text-gray-500 max-w-sm text-center">
                                        Once you complete home sample collection appointments, patient reviews will appear here.
                                    </p>
                                </div>
                            ) : (
                                <div className="space-y-4">
                                                    ...
                                                    <div className="flex justify-between items-start mb-4">
                                                        <div>
                                                            <div className="flex items-center gap-3 mb-1">
                                                                ...
                                                                {review.booking && (
                                                                    <Badge variant="outline" className="text-[10px] uppercase font-mono bg-green-50 text-green-700 border-green-200">
                                                                        Verified Visit
                                                                    </Badge>
                                                                )}
                                                            </div>
...
export default PhlebotomistReviews;
